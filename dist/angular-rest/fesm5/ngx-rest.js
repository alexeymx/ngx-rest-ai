...
var FileUpload = /** @class */ (function () {
    ...
    function (method, url, files, options) {
        ...
        /** @type {?} */
        var res = new HttpRequest(method, url, this.createFormData(options.params ? __assign({}, Params, options.params) : Params), { reportProgress: true, headers: new HttpHeaders(options.headers ? options.headers : {}) });
        return this.http
            .request(res)
            .pipe(map((/**
         * @param {?} event
...
var FileDownload = /** @class */ (function () {
    ...
    function (method, url, saveAs, options) {
        ...
        /** @type {?} */
        var res = method === 'GET'
            ? new HttpRequest(method, url, __assign({}, Options, { responseType: 'blob', params: Params }))
            : new HttpRequest(method, url, options.params || {}, __assign({}, Options, { responseType: 'blob' }));
        return this.http
            .request(res)
            .pipe(map((/**
         * @param {?} event
...
var RestClientService = /** @class */ (function () {
    ...
    /** @nocollapse */ RestClientService.ngInjectableDef = ɵɵdefineInjectable({ factory: function RestClientService_Factory() { return new RestClientService(ɵɵinject(HttpClient), ɵɵinject(CookieService), ɵɵinject(Router), ɵɵinject(RestServiceConfig, 8)); }, token: RestClientService, providedIn: "root" });
...
export { AngularRestModule, FileDownload, FileDownloadState, FileUpload, FileUploadState, RestClientService, RestServiceConfig, TypeTokenStorage };
